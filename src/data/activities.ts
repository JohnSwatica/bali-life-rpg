...
export const activityDefinitions: Activity[] = [
  ...
  },
  {
    ...
    label: "People-watch between coffees",
    description: "Keep the laptop open, but mostly read the room and let regulars start recognizing you.",
    categories: ["cafe", "coffee", "bakery"],
    venueIds: ["satu_satu_coffee", "milk_madu_berawa", "nude_cafe_berawa", "baked_berawa"],
    stationId: "cafe",
    actionLabel: "Linger",
    outcomePreview: "Costs a little, lifts Social and Wellbeing, and gives modest Focus.",
    stationReward: "Warmer venue familiarity without a full social night.",
    stationRisk: "Light productivity can become polished procrastination.",
    timeCost: 60,
    cost: 35,
    meterDeltas: { energy: -5, wellbeing: 7, focus: 5, social: 10 },
    affinityBump: 2,
    reputationEffect: { delta: 1, reason: "Became a familiar cafe face" },
    repeatable: true,
    requires: { openHoursOnly: true }
  },
  {
