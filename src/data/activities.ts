...
export const activityDefinitions: Activity[] = [
  ...
  },
  {
    ...
    label: "Work the Milk & Madu table",
    description: "Open the laptop at Milk & Madu and ship a focused client block before brunch takes over.",
  ...
  {
    id: "grab_coffee",
    label: "Order a Milk & Madu coffee",
    description: "Take a quick counter coffee at Milk & Madu before getting back on the road.",
  ...
  {
    id: "eat_properly",
    label: "Sit down for Milk & Madu brunch",
    description: "Order a proper plate at Milk & Madu instead of pretending another coffee is lunch.",
  ...
  },
  {
    ...
    description: "Close the day properly at home instead of passing out wherever the loop leaves you.",
    categories: ["shop"],
  ...
  },
  {
    ...
    description: "Turn your room into a practical base by packing something useful before the day pulls you out.",
    categories: ["shop"],
    venueIds: ["cheap_kos", "shared_room"],
    stationId: "home",
    actionLabel: "Prep",
