...
export const pickupDefinitions: PickupDefinition[] = [
  { id: "coconut-west", itemId: "coconut", x: 205, y: 1290, respawnMinutes: 420, label: "Fallen coconut" },
  { id: "coconut-jetty", itemId: "coconut", x: 590, y: 1340, respawnMinutes: 420, label: "Fallen coconut" },
  { id: "coconut-rocks", itemId: "coconut", x: 925, y: 1395, respawnMinutes: 420, label: "Fallen coconut" },
  { id: "flower-finns", itemId: "frangipani", x: 1840, y: 430, respawnMinutes: 240, label: "Frangipani blossom" },
  { id: "flower-berawa", itemId: "frangipani", x: 1380, y: 500, respawnMinutes: 240, label: "Frangipani blossom" }
];
