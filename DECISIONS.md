...
Regular status is a structural threshold, not affinity inflation. Completing the on-site participation beat increments attendance once per occurrence. The third attendance writes regular and activates the named `regularBenefit` hook exactly once; W2-04 supplies actual effects. The temporary `act2_test_crew` and its content-neutral session exist only to prove the loop and must be removed or repurposed by W2-02.
