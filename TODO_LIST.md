# To-Do List — Bali Life RPG

Parking lot for punted work, per global standing rule 6 (`~/.claude/CLAUDE.md`).
This file holds ONLY currently-open items — unlike `DECISIONS.md`, entries are
deleted once resolved, never marked done-and-kept. Check this file at the
start of every session, before acting on whatever new request just came in.
